        ...
        const newCardDiv =
           ...
           <div class="lg:w-2/3 px-6 py-4" id="recipeData">
               ...
               <p class="text-grey-darker text-base">
                ...
                <br>
               <button id="saveToAccount" dataurl="${url}" data-imageURL="${imageURL}" data-healthLabels="${healthLabels}" data-lable="${lable}" data-source="${source}" data-ingredients="${ingredients}"
